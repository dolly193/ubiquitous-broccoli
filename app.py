...
def finalize_file_processing(filename, user_id, conn, magnet_link=None):
    ...
    sql = "INSERT IGNORE INTO arquivos_dolly (hash, filename, size_bytes, owner_id, magnet_link) VALUES (%s, %s, %s, %s, %s)"
    cursor.execute(sql, (file_hash, filename, file_size, user_id, magnet_link))
